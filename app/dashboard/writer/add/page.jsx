...
export default function AddEbookPage() {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      if (!apiKey || apiKey === "your_imgbb_api_key") {
        toast.error("ImgBB API key not configured properly in env. Trying direct upload...");
      }
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/ebooks`, {
        ...formData,
    ...
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm mt-0.5">Share your original masterpiece with your readers.</p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2 md:col-span-2">
            ...
            <textarea
              required
              rows={12}
              placeholder="Write or paste your full book contents here. Readers who purchase the book will be able to read this entire text..."
